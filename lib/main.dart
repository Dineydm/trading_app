        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              GestureDetector(
                onTap: () => changePage(0),
                child: navItem(0, 'assets/images/home.svg'),
              ),
              GestureDetector(
                onTap: () => changePage(1),
                child: navItem(1, 'assets/images/transaction.svg'),
              ),
              GestureDetector(
                onTap: () => changePage(2),
                child: navItem(2, 'assets/images/message.svg'),
              ),
              GestureDetector(
                onTap: () => changePage(3),
                child: navItem(3, 'assets/images/user.svg'),
              ),
            ],
          ),
        ),

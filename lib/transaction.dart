          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: Style.backgroundColor2.withOpacity(.5),
                    ...
                    child: Column(
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            tranItem('assets/images/add.svg', 'Buy Gold',
                                Style.primaryColor),
                            tranItem('assets/images/tran.svg', 'Gold Transfer',
                                Style.chipColor),
                            tranItem('assets/images/down.svg', 'Sell Gold',
                                Style.primaryColor.withOpacity(.3)),
                          ],
                        ),
                        SizedBox(height: 20),
                      ],
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                style: GoogleFonts.poppins(
                                  color: Style.textColor1,
                                  fontSize: SizeConfig.mFontSize * .7,
                                  fontWeight: FontWeight.w600,
                                ),
                              ),
                            ],
              ...
              child: BezierChart(
                ...
                series: [
                  BezierLine(label: 'm', data: [
                    DataPoint<DateTime>(value: 1000, xAxis: DateTime(2016)),
                    DataPoint<DateTime>(value: 5000, xAxis: DateTime(2017)),
                    DataPoint<DateTime>(value: 3000, xAxis: DateTime(2018)),
                    DataPoint<DateTime>(value: 8000, xAxis: DateTime(2019)),
                    DataPoint<DateTime>(value: 6000, xAxis: DateTime(2020)),
                    DataPoint<DateTime>(value: 10000, xAxis: DateTime(2021)),
                  ])
                ],
